export const quantAnalysisFixture = {
    ...
    symbols: {
      SOXL: {
        ...
        entry_gate: {
          ...
          decision_close: 465,
          high_close: 655.95,
          drawdown: { current_pct: 29.11, required_pct: null, passed: null },
          moving_averages: [
            { period: 120, value: 453.523, touched: false, gap_pct: 2.53 },
            { period: 200, value: 421.5, touched: false, gap_pct: 10.32 },
          ],
          ma_touch_passed: false,
          reference_price: 469.25,
          reference_session: 'overnight',
          reason: '以 SOXX 闭市价判定｜不适用｜均线触及 ✗（MA120 还差 2.53%）',
        },
  ...
  review_checkpoint: {
    label: '夜盘审查',
    at: '09:40',
    checked_at: '2026-07-18T09:40:00+08:00',
    us_trading_day: '2026-07-17',
    notify: true,
    next_at: '11:00',
    stale: false,
